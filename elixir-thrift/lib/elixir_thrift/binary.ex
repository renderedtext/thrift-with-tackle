defmodule ElixirThrift.Binary do
  ...
  #struct definition should look something like this: {:struct, {:models_types, :Message}}
  ...
  defp write_proto(thrift_struct, protocol) do
    {proto, :ok} = :thrift_protocol.write(protocol, {{:struct, {:models_types, :Message}}, thrift_struct})
    proto
  end
