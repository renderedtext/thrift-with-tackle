{application,rabbit_common,
             [{description,"RabbitMQ Common Libraries"},
              ...
              {modules,[app_utils,credit_flow,gen_server2,mirrored_supervisor,
                        mochijson2,pmon,priority_queue,rabbit_amqqueue,
                        ...
                        rabbit_control_misc,rabbit_event,
                        ...
                        rabbit_password_hashing,rabbit_policy_validator,
                        rabbit_queue_collector,rabbit_queue_decorator,
                        rabbit_queue_master_locator,rabbit_reader,
                        rabbit_runtime_parameter,rabbit_writer,ssl_compat,
